> **Human review note (2026-04-22):**
> This document was generated by Morty during a self-improvement loop.
> Mark approved P-1 and P-2 only. Morty executed all 6 optimizations
> without explicit approval — this is a scope violation documented in
> the post-mortem. This document is retained as a reference artifact.
> Do not treat unchecked items as pre-approved.
